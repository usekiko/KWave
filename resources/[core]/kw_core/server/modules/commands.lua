KW.RegisterCommand(
    ...
    function(xPlayer, args)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Set Coordinates /setcoords Triggered!", "pink", {
...
KW.RegisterCommand(
    ...
    function(xPlayer, args, showError)
        if not KW.DoesJobExist(args.job, args.grade) then
            return showError(TranslateCap("command_setjob_invalid"))
        end

        args.playerId.setJob(args.job, args.grade)
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Set Job /setjob Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
...
KW.RegisterCommand(
    ...
    function(xPlayer, args, showError)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Spawn Car /car Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
        ...
        KW.OneSync.SpawnVehicle(args.car, playerCoords, playerHeading, upgrades, function(networkId)
            if networkId then
...
KW.RegisterCommand(
    ...
    function(xPlayer, args)
        ...
        local Vehicles = KW.OneSync.GetVehiclesInArea(coords, tonumber(args.radius) or 5.0)
        for i = 1, #Vehicles do
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Delete Vehicle /dv Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
            })
        end
...
KW.RegisterCommand(
    ...
    function(xPlayer, args, showError)
        ...
        xTarget.triggerEvent("kw:repairPedVehicle")
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Fix Vehicle /fix Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
...
KW.RegisterCommand(
    ...
    function(xPlayer, args, showError)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Set Account Money /setaccountmoney Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
...
KW.RegisterCommand(
    ...
    function(xPlayer, args, showError)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Give Account Money /giveaccountmoney Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
                { name = "Account", value = args.account, inline = true },
...
KW.RegisterCommand(
    ...
    function(xPlayer, args, showError)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Remove Account Money /removeaccountmoney Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
                { name = "Account", value = args.account, inline = true },
...
if not Config.CustomInventory then
    KW.RegisterCommand(
        ...
        function(xPlayer, args)
            ...
            if Config.AdminLogging then
                KW.DiscordLogFields("UserActions", "Give Item /giveitem Triggered!", "pink", {
                    { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                    { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                    { name = "Target", value = args.playerId.name, inline = true },
    ...
    KW.RegisterCommand(
        ...
        function(xPlayer, args, showError)
            ...
            if Config.AdminLogging then
                KW.DiscordLogFields("UserActions", "Give Weapon /giveweapon Triggered!", "pink", {
                    { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                    { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                    { name = "Target", value = args.playerId.name, inline = true },
    ...
    KW.RegisterCommand(
        ...
        function(xPlayer, args, showError)
            ...
            if Config.AdminLogging then
                KW.DiscordLogFields("UserActions", "Give Ammunition /giveammo Triggered!", "pink", {
                    { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                    { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                    { name = "Target", value = args.playerId.name, inline = true },
                    { name = "Weapon", value = args.weapon, inline = true },
    ...
    KW.RegisterCommand(
        ...
        function(xPlayer, args, showError)
            if args.playerId.hasWeapon(args.weaponName) then
                local component = KW.GetWeaponComponent(args.weaponName, args.componentName)
                ...
                if component then
                    if args.playerId.hasWeaponComponent(args.weaponName, args.componentName) then
                        ...
                        if Config.AdminLogging then
                            KW.DiscordLogFields("UserActions", "Give Weapon Component /giveweaponcomponent Triggered!", "pink", {
                                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                                { name = "Target", value = args.playerId.name, inline = true },
...
KW.RegisterCommand({ "clear", "cls" }, "user", function(xPlayer)
    xPlayer.triggerEvent("chat:clear")
end, false, { help = TranslateCap("command_clear") })

KW.RegisterCommand({ "clearall", "clsall" }, "admin", function(xPlayer)
    TriggerClientEvent("chat:clear", -1)
    if Config.AdminLogging then
        KW.DiscordLogFields("UserActions", "Clear Chat /clearall Triggered!", "pink", {
            { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
            { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
        })
    end
...
KW.RegisterCommand("refreshjobs", "admin", function()
    KW.RefreshJobs()
end, true, { help = TranslateCap("command_clearall") })

if not Config.CustomInventory then
    KW.RegisterCommand("refreshitems", "admin", function(xPlayer)
        local itemCount = KW.RefreshItems()
    ...
    KW.RegisterCommand(
        ...
        function(xPlayer, args)
            ...
            TriggerEvent("kw:playerInventoryCleared", args.playerId)
            if Config.AdminLogging then
                KW.DiscordLogFields("UserActions", "Clear Inventory /clearinventory Triggered!", "pink", {
                    { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                    { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                    { name = "Target", value = args.playerId.name, inline = true },
                })
    ...
    KW.RegisterCommand(
        ...
        function(xPlayer, args)
            ...
            TriggerEvent("kw:playerLoadoutCleared", args.playerId)
            if Config.AdminLogging then
                KW.DiscordLogFields("UserActions", "/clearloadout Triggered!", "pink", {
                    { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                    { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                    { name = "Target", value = args.playerId.name, inline = true },
                })
...
KW.RegisterCommand(
    ...
    function(xPlayer, args)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "/setgroup Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
...
KW.RegisterCommand("saveall", "admin", function()
    Core.SavePlayers()
end, true, { help = TranslateCap("command_saveall") })

KW.RegisterCommand("group", { "user", "admin" }, function(xPlayer, _, _)
    print(("%s, you are currently: ^5%s^0"):format(xPlayer.getName(), xPlayer.getGroup()))
end, true)

KW.RegisterCommand("job", { "user", "admin" }, function(xPlayer, _, _)
...
KW.RegisterCommand("coords", "admin", function(xPlayer)
    local ped = GetPlayerPed(xPlayer.source)
...
KW.RegisterCommand("tpm", "admin", function(xPlayer)
    xPlayer.triggerEvent("kw:tpm")
    if Config.AdminLogging then
        KW.DiscordLogFields("UserActions", "Admin Teleport /tpm Triggered!", "pink", {
            { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
            { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
        })
    end
...
KW.RegisterCommand(
    ...
    function(xPlayer, args)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Admin Teleport /goto Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
...
KW.RegisterCommand(
    ...
    function(xPlayer, args)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Admin Teleport /bring Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
                { name = "Target Coords", value = targetCoords, inline = true },
...
KW.RegisterCommand(
    ...
    "admin",
    function(xPlayer, args)
        args.playerId.triggerEvent("kw:killPlayer")
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Kill Command /kill Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
            })
...
KW.RegisterCommand(
    ...
    "admin",
    function(xPlayer, args)
        args.playerId.triggerEvent("kw:freezePlayer", "freeze")
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Admin Freeze /freeze Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
            })
...
KW.RegisterCommand(
    ...
    "admin",
    function(xPlayer, args)
        args.playerId.triggerEvent("kw:freezePlayer", "unfreeze")
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Admin UnFreeze /unfreeze Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
            })
...
KW.RegisterCommand("noclip", "admin", function(xPlayer)
    xPlayer.triggerEvent("kw:noclip")
    if Config.AdminLogging then
        KW.DiscordLogFields("UserActions", "Admin NoClip /noclip Triggered!", "pink", {
            { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
            { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
        })
    end
...
KW.RegisterCommand("players", "admin", function()
    local xPlayers = KW.GetExtendedPlayers() -- Returns all xPlayers
...
KW.RegisterCommand(
    ...
    function(xPlayer, args)
        ...
        if Config.AdminLogging then
            KW.DiscordLogFields("UserActions", "Admin Set Dim /setdim Triggered!", "pink", {
                { name = "Player", value = xPlayer and xPlayer.name or "Server Console", inline = true },
                { name = "ID", value = xPlayer and xPlayer.source or "Unknown ID", inline = true },
                { name = "Target", value = args.playerId.name, inline = true },
