...
function Callbacks:Trigger(player, event, cb, invoker, ...)
    ...
    TriggerClientEvent("kw:triggerClientCallback", player, event, self.id, invoker, ...)
...
function Callbacks:ServerRecieve(player, event, requestId, invoker, ...)
    ...
    local returnCb = function(...)
        TriggerClientEvent("kw:serverCallback", player, requestId, invoker, ...)
    end
...
---@param ... any
function KW.TriggerClientCallback(player, eventName, callback, ...)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "Unknown") and invokingResource or "kw_core"
...
---@param ... any
---@return ...
function KW.AwaitClientCallback(player, eventName, ...)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "Unknown") and invokingResource or "kw_core"
...
---@param callback function
---@return nil
function KW.RegisterServerCallback(eventName, callback)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "Unknown") and invokingResource or "kw_core"
...
---@param eventName string
---@return boolean
function KW.DoesServerCallbackExist(eventName)
...
RegisterNetEvent("kw:clientCallback", function(requestId, invoker, ...)
    Callbacks:RecieveClient(requestId, invoker, ...)
end)

RegisterNetEvent("kw:triggerServerCallback", function(eventName, requestId, invoker, ...)
    local source = source
