...
---@return number
function KW.Math.Round(value, numDecimalPlaces)
...
---@param value number
---@return string
function KW.Math.GroupDigits(value)
...
---@return number
function KW.Math.Random(minRange, maxRange)
...
---@param target vector
---@return number
function KW.Math.GetHeadingFromCoords(origin, target)
