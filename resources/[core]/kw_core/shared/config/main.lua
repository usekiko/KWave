...
local esxLocale = GetConvar("kw:locale", "invalid")
...
Config.EnableSocietyPayouts = false -- pay from the society account that the player is employed at? Requirement: kw_society
Config.MaxWeight = 49 -- the max inventory weight without a backpack
...
Config.Multichar = GetResourceState("kw_multicharacter") ~= "missing"
