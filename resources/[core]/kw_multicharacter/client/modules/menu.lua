...
function Menu:NewCharacter()
    ...
    TriggerServerEvent("kw_multicharacter:CharacterChosen", slot, true)
...
function Menu:PlayCharacter()
    Multicharacter:CloseUI()
    TriggerServerEvent("kw_multicharacter:CharacterChosen", Multicharacter.spawned, false)
end

function Menu:DeleteCharacter()
    TriggerServerEvent("kw_multicharacter:DeleteCharacter", Multicharacter.spawned)
