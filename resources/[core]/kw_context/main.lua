...
if Debug then
    ...
    RegisterCommand("ctx:preview", function()
        exports["kw_context"]:Preview(position, eles)
    end, false)

    RegisterCommand("ctx:open", function()
        exports["kw_context"]:Open(position, eles, onSelect, onClose)
    end, false)
    ...
    RegisterCommand("ctx:form", function()
        ...
        exports["kw_context"]:Open(position, formMenu, onSelect, onClose)
    end, false)
end
