...
---@param cb? function
---@return number | nil
function KW.Streaming.RequestModel(modelHash, cb)
...
---@param cb? function
---@return string | nil
function KW.Streaming.RequestStreamedTextureDict(textureDict, cb)
...
---@param cb? function
---@return string | nil
function KW.Streaming.RequestNamedPtfxAsset(assetName, cb)
...
---@param cb? function
---@return string | nil
function KW.Streaming.RequestAnimSet(animSet, cb)
...
---@param cb? function
---@return string | nil
function KW.Streaming.RequestAnimDict(animDict, cb)
...
function KW.Streaming.RequestWeaponAsset(weaponHash, cb)
