...
function Callbacks:Trigger(event, cb, invoker, ...)
    ...
    TriggerServerEvent("kw:triggerServerCallback", event, self.id, invoker, ...)
...
function Callbacks:ClientRecieve(eventName, requestId, invoker, ...)
    ...
    local returnCb = function(...)
        TriggerServerEvent("kw:clientCallback", requestId, invoker, ...)
    end
...
---@param ... any
---@return nil
function KW.TriggerServerCallback(eventName, callback, ...)
...
---@param ... any
---@return ...
function KW.AwaitServerCallback(eventName, ...)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "unknown") and invokingResource or "kw_core"
...
function KW.RegisterClientCallback(eventName, callback)
    local invokingResource = GetInvokingResource()
    local invoker = (invokingResource and invokingResource ~= "Unknown") and invokingResource or "kw_core"
...
---@param eventName string
---@return boolean
function KW.DoesClientCallbackExist(eventName)
...
KW.SecureNetEvent("kw:serverCallback", function(...)
    Callbacks:ServerRecieve(...)
end)

KW.SecureNetEvent("kw:triggerClientCallback", function(...)
